...
rlogical-lap-23@devops:~/terraform-vpc/modules/vpc$ ls
data.tf  main.tf  outputs.tf  variables.tf
rlogical-lap-23@devops:~/terraform-vpc/modules/vpc$ cat main.tf 
resource "aws_vpc" "discusit-vpc" {
  cidr_block = var.vpc_cidr_block
