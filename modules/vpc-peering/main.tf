...
resource "aws_route" "vpc1-to-vpc2-peering-route" {
  ...
  destination_cidr_block    = var.refrence-vpc2-public-subnet-cidr-block # CIDR block of VPC1
...
resource "aws_route" "vpc2-to-vpc1-peering-route" {
  ...
  destination_cidr_block    = var.refrence-vpc1-public-subnet-cidr-block # CIDR block of VPC2
  vpc_peering_connection_id = var.refrence-vpc-peering-connection-id
}
